...
/* for image1[ ][ ]，x_size1，y_size1 */
{
    ...
    /* Input file open */
    printf("\n-----------------------------------------------------\n");
    printf("Bilateral filtering input\n");
    printf("-----------------------------------------------------\n\n");
    printf("     Only pgm binary file is acceptable\n\n");
    printf("Insert here name of the image (*.pgm) : ");
    scanf("%s", file_name);
...

{
    ...
    /* Output file open */
    printf("-----------------------------------------------------\n");
    printf("Bilateral filtering output \n");
    printf("-----------------------------------------------------\n\n");
    printf("Insert here name of the output image (*.pgm) : ");
    scanf("%s", file_name);
